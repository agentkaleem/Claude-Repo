---
name: push-code
description: "Push code with commit messages. Use when user wants to push my code | commit and push. Handles branch creation from staging, file staging, professional commit messages (RB-XXXX format), and remote push with verification."
---
